...
export function Sidebar({ role }: SidebarProps) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/80">
              Espace Design Mobilier National - Plateforme de communication
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="hidden md:flex h-screen w-72 flex-col border-r shadow-sm" style={{ backgroundColor: 'oklch(0.55 0.15 160)' }}>
      {sidebarContent}
    </div>
  );
}
